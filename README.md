...
## Model Training
The three CNN models (North, Central, and South) are trained via PyTorch and can be found in the respective notebooks [here](/modeling/Train_CNNs_Simulations).
